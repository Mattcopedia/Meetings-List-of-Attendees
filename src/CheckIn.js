...
// class CheckIn extends Component {
//   constructor(props) {
//     // puttings props here makes it to be available anywhere in my application
...
//   handleSubmit(e) {
//     e.preventDefault();
//     // we use ref push to push data like attendee Name and Email to display on checkin page
//     const ref = firebase
//       .database()
//       .ref(`meetings/${this.props.userID}/${this.props.meetingID}/attendees`);
//     ref.push({
